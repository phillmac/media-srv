...
function ffmpeg_mpegts_mp3_av_icecast_out () {
    ...
    ffmpeg_av_icecast_br="${ffmpeg_av_icecast_br:--b:a 192k}"     
    ffmpeg_icecast_ar="${ffmpeg_av_icecast_ar:--ar 44100}"
...
export -f ffmpeg_mpegts_mp3_av_icecast_out
